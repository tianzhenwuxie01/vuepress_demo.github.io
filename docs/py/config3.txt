        ...
        sidebar: [                    {
    ...
    
                    {
                        ...
                        children: [
                            ...
                            ['/pages/学习/python01.md', 'python01'],
                            ['/pages/学习/python02.md', 'python02'],
                            ['/pages/学习/python03.md', 'python03'],
                            ['/pages/学习/python04.md', 'python04'],
                            ['/pages/学习/python05.md', 'python05'],
                            ['/pages/学习/python06.md', 'python06'],
