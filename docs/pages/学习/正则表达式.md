...
> 搬运来源：[https://github.com/ziishaned/learn-regex/blob/master/translations/README-cn.md](https://github.com/ziishaned/learn-regex/blob/master/translations/README-cn.md)
...
> xxx 的后面跟着 yyy，那么这个 xxx 被选中
> 正向先行断言。正向等于负向不等于。先行看前面（xxx）后发看后面
...
- **多个汉字**: `^[\u4e00-\u9fa5]{0,}$`
- **字母数字字符**: `^[a-zA-Z0-9]*$`
- **英文和数字**: `英文和数字^[A-Za-z0-9]+$ 或 ^[A-Za-z0-9]{4,40}$`
...
[\x{4e00}-\x{9fa5}]  # c+支持匹配中文了
[\u4e00-\u9fa5]  # python支持匹配中文了,c##也可以
(?i:jp)              # 用(?i:jp)就能匹配到大写或者小写的jp
